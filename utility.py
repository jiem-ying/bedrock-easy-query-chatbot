...
encryption_policy_name = f"bedrock-easy-query-sp-{suffix}"
network_policy_name = f"bedrock-easy-query-np-{suffix}"
access_policy_name = f'bedrock-easy-query-ap-{suffix}'
...
def delete_iam_role_and_policies():
    # bedrock_execution_role_arn = f"arn:aws:iam::{account_number}:role/{bedrock_execution_role_name}"
